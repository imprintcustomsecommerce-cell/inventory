...
<div class="mx-auto max-w-2xl">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold tracking-tight text-zinc-900">New invoice</h1>
    ...
    <form action="{{ route('invoices.store') }}" method="POST" class="card divide-y divide-zinc-200">
        @csrf
        @include('store.invoices.partials.form-fields')
