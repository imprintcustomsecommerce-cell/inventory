        ...
        <div class="space-y-5 p-6">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" name="minimum_stock" value="{{ old('minimum_stock', $item->minimum_stock) }}" min="0" step="1" required class="input @error('minimum_stock') input-error @enderror">
