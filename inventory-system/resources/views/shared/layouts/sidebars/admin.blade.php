...
<nav class="flex-1 space-y-1">
    ...
    @php
        $unreadActivity = \App\Models\Activity::where('created_at', '>', auth()->user()->activity_seen_at ?? '1970-01-01')
    ...
    <a href="{{ route('activity.index') }}" class="nav-link {{ request()->routeIs('activity.*') ? 'nav-link-active' : '' }}">
        ...
        @if($unreadActivity > 0)<span class="rounded-full bg-brand-400 px-2 py-0.5 text-[10px] font-bold text-zinc-900">{{ $unreadActivity > 99 ? '99+' : $unreadActivity }}</span>@endif
    </a>

    <p class="nav-section-title pt-5">Manage</p>
    ...
    <p class="nav-section-title pt-5">Purchasing</p>
    ...
    <p class="nav-section-title pt-5">Production</p>
    ...
    <p class="nav-section-title pt-5">Online Store</p>
    ...
    <a href="{{ route('online-orders.index') }}" class="nav-link {{ request()->routeIs('online-orders.*') ? 'nav-link-active' : '' }}">
        ...
        @if($newOnlineOrders > 0)<span class="rounded-full bg-brand-400 px-2 py-0.5 text-[10px] font-bold text-zinc-900">{{ $newOnlineOrders }}</span>@endif
    </a>
    ...
    <p class="nav-section-title pt-5">Admin</p>
