...
<div class="mx-auto max-w-2xl">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold tracking-tight text-zinc-900">New project</h1>
        <p class="mt-1 text-sm text-zinc-500">Create a customer order. You'll add its materials next.</p>
    </div>

    <form action="{{ route('projects.store') }}" method="POST" class="card divide-y divide-zinc-200">
        @csrf
        @include('shared.projects.partials.form-fields')
