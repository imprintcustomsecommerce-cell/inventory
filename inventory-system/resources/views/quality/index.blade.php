...
<div class="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
    @php
        $cards = [
            ['label' => 'Open issues', 'value' => $stats['open'], 'accent' => 'text-red-600'],
            ['label' => 'Reprints', 'value' => $stats['reprints'], 'accent' => 'text-amber-600'],
            ['label' => 'Returns', 'value' => $stats['returns'], 'accent' => 'text-zinc-900'],
            ['label' => 'Total rework cost', 'value' => '₱' . number_format($stats['rework_cost'], 2), 'accent' => 'text-zinc-900'],
        ];
    @endphp
    @foreach($cards as $c)
        <div class="card p-5">
