...
<div class="mx-auto max-w-2xl">
    ...
    <div class="mb-6 rounded-xl border border-blue-200 bg-blue-50 p-5 text-sm text-blue-900">
        ...
        <p class="mt-2 text-blue-800">Choose the target warehouse below — you can import into a stockroom or a store. Image downloads need internet during the import; once saved they work offline.</p>
    </div>
