...
class MaterialController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return role_view('materials.index', compact('materials', 'categories', 'warehouses', 'lowCount'));
    }
    ...
    public function create()
    {
        ...
        return role_view('materials.form', [
    ...
    public function movementForm(Material $material)
    {
        ...
        return role_view('materials.movement', compact('material'));
    }
    ...
    public function movements(Material $material)
    {
        ...
        return role_view('materials.movements', compact('material', 'movements'));
    }
