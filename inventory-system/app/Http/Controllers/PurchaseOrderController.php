...
class PurchaseOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('purchases.index', compact('orders', 'stats'));
    }
    ...
    public function show(PurchaseOrder $purchase)
    {
        ...
        return view('purchases.show', compact('purchase', 'materials'));
    }
    ...
    public function pdf(PurchaseOrder $purchase)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('purchases.pdf', ['order' => $purchase])
            ->setPaper('a4');
