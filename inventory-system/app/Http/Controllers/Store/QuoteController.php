...
class QuoteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return role_view('store.quotes.index', compact('quotes', 'stats'));
    }
    ...
    public function create()
    {
        ...
        return role_view('store.quotes.create', compact('customers', 'nextNumber'));
    }
    ...
    public function show(Quote $quote)
    {
        ...
        return role_view('store.quotes.show', compact('quote'));
    }
    ...
    public function edit(Quote $quote)
    {
        ...
        return role_view('store.quotes.edit', compact('quote', 'customers'));
    }
    ...
    public function pdf(Quote $quote)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('store.quotes.pdf', compact('quote'))
            ->setPaper('a4');
