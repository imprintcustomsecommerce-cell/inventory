...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return role_view('warehouse.inventory.index', compact('items', 'categories', 'stats', 'warehouses'));
    }
    ...
    public function create()
    {
        ...
        return role_view('warehouse.inventory.create', compact('warehouses'));
    }
    ...
    public function edit(InventoryItem $inventoryItem)
    {
        ...
        return role_view('warehouse.inventory.edit', ['item' => $inventoryItem, 'warehouses' => $warehouses]);
    }
    ...
    public function trash()
    {
        ...
        return role_view('warehouse.inventory.trash', compact('items'));
    }
    ...
    public function stockInForm(InventoryItem $inventoryItem)
    {
        ...
        return role_view('warehouse.inventory.stock-in', ['item' => $inventoryItem]);
    }
    ...
    public function stockOutForm(InventoryItem $inventoryItem)
    {
        ...
        return role_view('warehouse.inventory.stock-out', ['item' => $inventoryItem]);
    }
    ...
    public function adjustForm(InventoryItem $inventoryItem)
    {
        ...
        return role_view('warehouse.inventory.adjust', ['item' => $inventoryItem]);
    }
    ...
    public function movements(InventoryItem $inventoryItem)
    {
        ...
        return role_view('warehouse.inventory.movements', ['item' => $inventoryItem, 'movements' => $movements]);
    }
    ...
    public function transferForm(Request $request, InventoryItem $inventoryItem)
    {
        ...
        return role_view('warehouse.inventory.transfer', [
            'item' => $inventoryItem,
    ...
    {
        return role_view('warehouse.inventory.import');
    }
    ...
    public function allMovements(Request $request)
    {
        ...
        return role_view('warehouse.inventory.all-movements', compact('movements'));
    }
