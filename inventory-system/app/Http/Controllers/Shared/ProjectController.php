...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return role_view('shared.projects.index', compact('projects', 'stats'));
    }
    ...
    public function create()
    {
        ...
        return role_view('shared.projects.create', compact('customers'));
    }
    ...
    public function show(Project $project)
    {
        ...
        return role_view('shared.projects.show', compact('project', 'items'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        return role_view('shared.projects.edit', compact('project', 'customers'));
    }
    ...
    public function pdf(Project $project)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('shared.projects.pdf', compact('project'))
            ->setPaper('a4');
